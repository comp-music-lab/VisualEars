...
For each random sample, we adjusted the number of participants per country (in this case, \emph{n} = 25) to achieve the target statistical power of at least \(1 - \beta = 0.95\) for both the Density and Arousal models, for the contrast between Tempo levels (i.e., averaged over the levels of Instrumentation (\texttt{Solo.group}), participant country (\texttt{Participant.country}) and Music country (\texttt{Music.country}).
...
\hline
\hspace{1em}1|2 & -1.74 & 0.22 & -8.06 & \textbf{< 0.0001}\\
\hspace{1em}2|3 & -0.29 & 0.19 & -1.51 & 0.13\\
\hspace{1em}3|4 & 1.67 & 0.21 & 7.90 & \textbf{< 0.0001}\\
\hspace{1em}4|5 & 3.80 & 0.31 & 12.07 & \textbf{< 0.0001}\\
\addlinespace[0.3em]
\hline
\multicolumn{5}{l}{\textbf{Terms}}\\
\hline
\hspace{1em}Tempo [Low] & -0.41 & 0.12 & -3.44 & \textbf{< 0.001}\\
\hspace{1em}Instrumentation [Group] & 1.54 & 0.15 & 10.33 & \textbf{< 0.0001}\\
\hspace{1em}Participant country [Canada] & 0.38 & 0.24 & 1.63 & 0.1\\
\hspace{1em}Participant country [Iran] & -0.25 & 0.21 & -1.19 & 0.23\\
\hspace{1em}Music country [Canada] & 0.31 & 0.17 & 1.83 & 0.07\\
\hspace{1em}Music country [Iran] & -0.28 & 0.17 & -1.69 & 0.09\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] & 0.00 & 0.12 & 0.03 & 0.98\\
\hspace{1em}Tempo [Low] × Participant country [Canada] & 0.02 & 0.17 & 0.12 & 0.9\\
\hspace{1em}Tempo [Low] × Participant country [Iran] & 0.04 & 0.15 & 0.30 & 0.77\\
\hspace{1em}Instrumentation [Group] × Participant country [Canada] & 0.07 & 0.17 & 0.39 & 0.7\\
\hspace{1em}Instrumentation [Group] × Participant country [Iran] & -0.11 & 0.15 & -0.73 & 0.46\\
\hspace{1em}Tempo [Low] × Music country [Canada] & 0.07 & 0.17 & 0.41 & 0.68\\
\hspace{1em}Tempo [Low] × Music country [Iran] & -0.21 & 0.17 & -1.29 & 0.2\\
\hspace{1em}Instrumentation [Group] × Music country [Canada] & 0.21 & 0.17 & 1.27 & 0.21\\
\hspace{1em}Instrumentation [Group] × Music country [Iran] & -0.06 & 0.17 & -0.37 & 0.71\\
\hspace{1em}Participant country [Canada] × Music country [Canada] & 0.05 & 0.25 & 0.20 & 0.84\\
\hspace{1em}Participant country [Iran] × Music country [Canada] & -0.28 & 0.22 & -1.28 & 0.2\\
\hspace{1em}Participant country [Canada] × Music country [Iran] & -0.13 & 0.24 & -0.55 & 0.58\\
\hspace{1em}Participant country [Iran] × Music country [Iran] & 0.08 & 0.21 & 0.40 & 0.69\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Canada] & -0.04 & 0.17 & -0.25 & 0.81\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Iran] & 0.14 & 0.15 & 0.93 & 0.35\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Music country [Canada] & -0.13 & 0.17 & -0.75 & 0.45\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Music country [Iran] & 0.23 & 0.17 & 1.39 & 0.17\\
\hspace{1em}Tempo [Low] × Participant country [Canada] × Music country [Canada] & 0.10 & 0.25 & 0.40 & 0.69\\
\hspace{1em}Tempo [Low] × Participant country [Iran] × Music country [Canada] & -0.11 & 0.22 & -0.50 & 0.62\\
\hspace{1em}Tempo [Low] × Participant country [Canada] × Music country [Iran] & -0.24 & 0.24 & -1.01 & 0.31\\
\hspace{1em}Tempo [Low] × Participant country [Iran] × Music country [Iran] & 0.42 & 0.21 & 2.01 & \textbf{0.0441}\\
\hspace{1em}Instrumentation [Group] × Participant country [Canada] × Music country [Canada] & -0.25 & 0.25 & -1.02 & 0.31\\
\hspace{1em}Instrumentation [Group] × Participant country [Iran] × Music country [Canada] & 0.18 & 0.22 & 0.84 & 0.4\\
\hspace{1em}Instrumentation [Group] × Participant country [Canada] × Music country [Iran] & 0.03 & 0.24 & 0.13 & 0.9\\
\hspace{1em}Instrumentation [Group] × Participant country [Iran] × Music country [Iran] & -0.23 & 0.21 & -1.11 & 0.27\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Canada] × Music country [Canada] & -0.27 & 0.25 & -1.09 & 0.27\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Iran] × Music country [Canada] & 0.22 & 0.22 & 1.02 & 0.31\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Canada] × Music country [Iran] & 0.08 & 0.24 & 0.34 & 0.73\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Iran] × Music country [Iran] & -0.47 & 0.21 & -2.23 & \textbf{0.0257}\\
\bottomrule
\end{tabular}}
\end{table}
...
\multicolumn{5}{l}{\textbf{Thresholds}}\\
\hline
\hspace{1em}1|2 & -2.36 & 0.22 & -10.56 & \textbf{< 0.0001}\\
\hspace{1em}2|3 & -0.29 & 0.18 & -1.64 & 0.1\\
\hspace{1em}3|4 & 2.36 & 0.23 & 10.04 & \textbf{< 0.0001}\\
\hspace{1em}4|5 & 3.92 & 0.32 & 12.25 & \textbf{< 0.0001}\\
\addlinespace[0.3em]
\hline
\multicolumn{5}{l}{\textbf{Terms}}\\
\hline
\hspace{1em}Tempo [Low] & -0.64 & 0.12 & -5.32 & \textbf{< 0.0001}\\
\hspace{1em}Instrumentation [Group] & 1.45 & 0.15 & 9.87 & \textbf{< 0.0001}\\
\hspace{1em}Participant country [Canada] & -0.05 & 0.21 & -0.23 & 0.81\\
\hspace{1em}Participant country [Iran] & 0.19 & 0.19 & 1.02 & 0.31\\
\hspace{1em}Music country [Canada] & 0.23 & 0.16 & 1.43 & 0.15\\
\hspace{1em}Music country [Iran] & -0.07 & 0.16 & -0.43 & 0.67\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] & -0.18 & 0.12 & -1.51 & 0.13\\
\hspace{1em}Tempo [Low] × Participant country [Canada] & -0.06 & 0.16 & -0.37 & 0.71\\
\hspace{1em}Tempo [Low] × Participant country [Iran] & 0.15 & 0.15 & 1.03 & 0.3\\
\hspace{1em}Instrumentation [Group] × Participant country [Canada] & -0.07 & 0.16 & -0.42 & 0.68\\
\hspace{1em}Instrumentation [Group] × Participant country [Iran] & 0.11 & 0.15 & 0.75 & 0.45\\
\hspace{1em}Tempo [Low] × Music country [Canada] & 0.00 & 0.16 & -0.02 & 0.98\\
\hspace{1em}Tempo [Low] × Music country [Iran] & -0.20 & 0.16 & -1.26 & 0.21\\
\hspace{1em}Instrumentation [Group] × Music country [Canada] & 0.00 & 0.16 & 0.02 & 0.99\\
\hspace{1em}Instrumentation [Group] × Music country [Iran] & 0.03 & 0.16 & 0.19 & 0.85\\
\hspace{1em}Participant country [Canada] × Music country [Canada] & 0.10 & 0.23 & 0.45 & 0.65\\
\hspace{1em}Participant country [Iran] × Music country [Canada] & 0.15 & 0.21 & 0.70 & 0.48\\
\hspace{1em}Participant country [Canada] × Music country [Iran] & -0.11 & 0.23 & -0.48 & 0.63\\
\hspace{1em}Participant country [Iran] × Music country [Iran] & 0.01 & 0.21 & 0.06 & 0.95\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Canada] & -0.01 & 0.16 & -0.04 & 0.97\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Iran] & 0.18 & 0.15 & 1.24 & 0.21\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Music country [Canada] & -0.10 & 0.16 & -0.63 & 0.53\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Music country [Iran] & 0.06 & 0.16 & 0.35 & 0.73\\
\hspace{1em}Tempo [Low] × Participant country [Canada] × Music country [Canada] & -0.07 & 0.23 & -0.31 & 0.76\\
\hspace{1em}Tempo [Low] × Participant country [Iran] × Music country [Canada] & 0.02 & 0.21 & 0.10 & 0.92\\
\hspace{1em}Tempo [Low] × Participant country [Canada] × Music country [Iran] & 0.37 & 0.23 & 1.58 & 0.11\\
\hspace{1em}Tempo [Low] × Participant country [Iran] × Music country [Iran] & -0.48 & 0.21 & -2.30 & \textbf{0.0214}\\
\hspace{1em}Instrumentation [Group] × Participant country [Canada] × Music country [Canada] & -0.13 & 0.23 & -0.57 & 0.57\\
\hspace{1em}Instrumentation [Group] × Participant country [Iran] × Music country [Canada] & -0.05 & 0.21 & -0.23 & 0.82\\
\hspace{1em}Instrumentation [Group] × Participant country [Canada] × Music country [Iran] & -0.28 & 0.23 & -1.20 & 0.23\\
\hspace{1em}Instrumentation [Group] × Participant country [Iran] × Music country [Iran] & 0.19 & 0.21 & 0.92 & 0.36\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Canada] × Music country [Canada] & -0.15 & 0.23 & -0.65 & 0.51\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Iran] × Music country [Canada] & 0.40 & 0.21 & 1.92 & 0.05\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Canada] × Music country [Iran] & 0.23 & 0.23 & 0.98 & 0.33\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Iran] × Music country [Iran] & -0.34 & 0.21 & -1.64 & 0.1\\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
Low & -1.27 & 0.21 & -1.69 & -0.84 & Low - High & -0.81 & 0.24 & -3.44 & \textbf{< 0.001}\\
High & -0.46 & 0.20 & -0.84 & -0.07 &  &  &  &  & \\
\bottomrule
\end{tabular}
...
Tempo & EMM & $SE$ & $2.5\% CI$ & $97.5\% CI$ & Contrast & Difference & $SE$ & $z$ & $p$\\
\midrule
Low & -1.55 & 0.21 & -1.96 & -1.13 & Low - High & -1.28 & 0.24 & -5.32 & \textbf{< 0.0001}\\
High & -0.27 & 0.19 & -0.63 & 0.10 &  &  &  &  & \\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
