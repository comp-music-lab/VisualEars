...
\NormalTok{sample\_size.clmm }\OtherTok{=} \DecValTok{28} 
...
For each random sample, we adjusted the number of participants per country (in this case, \emph{n} = 28) to achieve the target statistical power of at least \(1 - \beta = 0.95\) for both the Density and Arousal models, for the contrast between Tempo levels (i.e., averaged over the levels of Instrumentation (\texttt{Solo.group}), participant country (\texttt{Participant.country}) and Music country (\texttt{Music.country}).
...
In all cases, results are for main effects and all possible interactions between Tempo (Low, High), Instrumentation (Group, Solo), Participant country (Iran, Canada, Japan), and Music country (Iran, Canada, Japan) as fixed effects, as well as random intercepts and random slopes between Tempo conditions for each participant. \emph{High} was used as reference category for Tempo, and \emph{Japan} for both participant and music country. Contrasted levels are in square brackets.
...
\hline
\hspace{1em}1|2 & -1.84 & 0.19 & -9.74 & \textbf{< 0.0001}\\
\hspace{1em}2|3 & -0.03 & 0.16 & -0.20 & 0.84\\
\hspace{1em}3|4 & 1.92 & 0.18 & 10.43 & \textbf{< 0.0001}\\
\hspace{1em}4|5 & 4.10 & 0.31 & 13.21 & \textbf{< 0.0001}\\
\addlinespace[0.3em]
\hline
\multicolumn{5}{l}{\textbf{Terms}}\\
\hline
\hspace{1em}Tempo [Low] & -0.54 & 0.11 & -4.87 & \textbf{< 0.0001}\\
\hspace{1em}Instrumentation [Group] & 1.46 & 0.14 & 10.77 & \textbf{< 0.0001}\\
\hspace{1em}Participant country [Canada] & 0.35 & 0.16 & 2.11 & \textbf{0.0351}\\
\hspace{1em}Participant country [Iran] & 0.01 & 0.19 & 0.04 & 0.97\\
\hspace{1em}Music country [Canada] & -0.17 & 0.16 & -1.13 & 0.26\\
\hspace{1em}Music country [Iran] & 0.00 & 0.15 & -0.02 & 0.98\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] & 0.10 & 0.11 & 0.94 & 0.35\\
\hspace{1em}Tempo [Low] × Participant country [Canada] & -0.03 & 0.14 & -0.23 & 0.82\\
\hspace{1em}Tempo [Low] × Participant country [Iran] & -0.07 & 0.16 & -0.40 & 0.69\\
\hspace{1em}Instrumentation [Group] × Participant country [Canada] & 0.08 & 0.14 & 0.58 & 0.56\\
\hspace{1em}Instrumentation [Group] × Participant country [Iran] & 0.10 & 0.16 & 0.61 & 0.54\\
\hspace{1em}Tempo [Low] × Music country [Canada] & 0.09 & 0.16 & 0.57 & 0.57\\
\hspace{1em}Tempo [Low] × Music country [Iran] & 0.13 & 0.15 & 0.86 & 0.39\\
\hspace{1em}Instrumentation [Group] × Music country [Canada] & 0.03 & 0.16 & 0.16 & 0.87\\
\hspace{1em}Instrumentation [Group] × Music country [Iran] & 0.10 & 0.15 & 0.67 & 0.5\\
\hspace{1em}Participant country [Canada] × Music country [Canada] & 0.32 & 0.20 & 1.57 & 0.12\\
\hspace{1em}Participant country [Iran] × Music country [Canada] & -0.32 & 0.24 & -1.34 & 0.18\\
\hspace{1em}Participant country [Canada] × Music country [Iran] & 0.14 & 0.20 & 0.72 & 0.47\\
\hspace{1em}Participant country [Iran] × Music country [Iran] & 0.11 & 0.23 & 0.47 & 0.64\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Canada] & 0.00 & 0.14 & -0.03 & 0.97\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Iran] & 0.14 & 0.16 & 0.86 & 0.39\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Music country [Canada] & 0.07 & 0.15 & 0.43 & 0.67\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Music country [Iran] & -0.20 & 0.15 & -1.35 & 0.18\\
\hspace{1em}Tempo [Low] × Participant country [Canada] × Music country [Canada] & 0.17 & 0.20 & 0.82 & 0.41\\
\hspace{1em}Tempo [Low] × Participant country [Iran] × Music country [Canada] & -0.37 & 0.24 & -1.54 & 0.12\\
\hspace{1em}Tempo [Low] × Participant country [Canada] × Music country [Iran] & -0.29 & 0.20 & -1.48 & 0.14\\
\hspace{1em}Tempo [Low] × Participant country [Iran] × Music country [Iran] & 0.35 & 0.23 & 1.53 & 0.12\\
\hspace{1em}Instrumentation [Group] × Participant country [Canada] × Music country [Canada] & -0.08 & 0.20 & -0.41 & 0.68\\
\hspace{1em}Instrumentation [Group] × Participant country [Iran] × Music country [Canada] & -0.20 & 0.24 & -0.85 & 0.4\\
\hspace{1em}Instrumentation [Group] × Participant country [Canada] × Music country [Iran] & -0.07 & 0.20 & -0.37 & 0.71\\
\hspace{1em}Instrumentation [Group] × Participant country [Iran] × Music country [Iran] & -0.18 & 0.23 & -0.78 & 0.44\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Canada] × Music country [Canada] & -0.14 & 0.20 & -0.70 & 0.48\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Iran] × Music country [Canada] & 0.63 & 0.24 & 2.65 & \textbf{0.008}\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Canada] × Music country [Iran] & 0.04 & 0.20 & 0.18 & 0.86\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Iran] × Music country [Iran] & -0.35 & 0.23 & -1.54 & 0.12\\
\bottomrule
\end{tabular}}
\end{table}
...
\multicolumn{5}{l}{\textbf{Thresholds}}\\
\hline
\hspace{1em}1|2 & -2.11 & 0.21 & -9.97 & \textbf{< 0.0001}\\
\hspace{1em}2|3 & -0.37 & 0.18 & -2.11 & \textbf{0.0351}\\
\hspace{1em}3|4 & 1.98 & 0.21 & 9.57 & \textbf{< 0.0001}\\
\hspace{1em}4|5 & 3.31 & 0.27 & 12.43 & \textbf{< 0.0001}\\
\addlinespace[0.3em]
\hline
\multicolumn{5}{l}{\textbf{Terms}}\\
\hline
\hspace{1em}Tempo [Low] & -0.40 & 0.11 & -3.77 & \textbf{< 0.001}\\
\hspace{1em}Instrumentation [Group] & 1.40 & 0.13 & 10.37 & \textbf{< 0.0001}\\
\hspace{1em}Participant country [Canada] & -0.43 & 0.20 & -2.19 & \textbf{0.0285}\\
\hspace{1em}Participant country [Iran] & 0.26 & 0.22 & 1.16 & 0.25\\
\hspace{1em}Music country [Canada] & -0.03 & 0.15 & -0.23 & 0.81\\
\hspace{1em}Music country [Iran] & -0.16 & 0.15 & -1.07 & 0.28\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] & -0.13 & 0.11 & -1.22 & 0.22\\
\hspace{1em}Tempo [Low] × Participant country [Canada] & -0.07 & 0.14 & -0.51 & 0.61\\
\hspace{1em}Tempo [Low] × Participant country [Iran] & 0.31 & 0.16 & 1.96 & \textbf{0.0495}\\
\hspace{1em}Instrumentation [Group] × Participant country [Canada] & 0.31 & 0.14 & 2.22 & \textbf{0.0266}\\
\hspace{1em}Instrumentation [Group] × Participant country [Iran] & -0.28 & 0.16 & -1.75 & 0.08\\
\hspace{1em}Tempo [Low] × Music country [Canada] & 0.08 & 0.15 & 0.51 & 0.61\\
\hspace{1em}Tempo [Low] × Music country [Iran] & 0.13 & 0.15 & 0.86 & 0.39\\
\hspace{1em}Instrumentation [Group] × Music country [Canada] & -0.04 & 0.15 & -0.25 & 0.8\\
\hspace{1em}Instrumentation [Group] × Music country [Iran] & 0.07 & 0.15 & 0.46 & 0.64\\
\hspace{1em}Participant country [Canada] × Music country [Canada] & -0.28 & 0.20 & -1.41 & 0.16\\
\hspace{1em}Participant country [Iran] × Music country [Canada] & 0.18 & 0.22 & 0.81 & 0.42\\
\hspace{1em}Participant country [Canada] × Music country [Iran] & 0.28 & 0.20 & 1.42 & 0.16\\
\hspace{1em}Participant country [Iran] × Music country [Iran] & -0.08 & 0.22 & -0.37 & 0.71\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Canada] & 0.09 & 0.14 & 0.61 & 0.54\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Iran] & 0.00 & 0.16 & -0.01 & 0.99\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Music country [Canada] & -0.08 & 0.15 & -0.55 & 0.58\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Music country [Iran] & 0.09 & 0.15 & 0.61 & 0.54\\
\hspace{1em}Tempo [Low] × Participant country [Canada] × Music country [Canada] & 0.00 & 0.20 & 0.01 & 0.99\\
\hspace{1em}Tempo [Low] × Participant country [Iran] × Music country [Canada] & -0.20 & 0.22 & -0.91 & 0.36\\
\hspace{1em}Tempo [Low] × Participant country [Canada] × Music country [Iran] & 0.13 & 0.20 & 0.66 & 0.51\\
\hspace{1em}Tempo [Low] × Participant country [Iran] × Music country [Iran] & 0.05 & 0.22 & 0.23 & 0.82\\
\hspace{1em}Instrumentation [Group] × Participant country [Canada] × Music country [Canada] & 0.16 & 0.20 & 0.83 & 0.41\\
\hspace{1em}Instrumentation [Group] × Participant country [Iran] × Music country [Canada] & 0.17 & 0.22 & 0.78 & 0.44\\
\hspace{1em}Instrumentation [Group] × Participant country [Canada] × Music country [Iran] & -0.01 & 0.20 & -0.06 & 0.95\\
\hspace{1em}Instrumentation [Group] × Participant country [Iran] × Music country [Iran] & -0.39 & 0.22 & -1.76 & 0.08\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Canada] × Music country [Canada] & 0.35 & 0.20 & 1.76 & 0.08\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Iran] × Music country [Canada] & -0.12 & 0.22 & -0.57 & 0.57\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Canada] × Music country [Iran] & -0.26 & 0.20 & -1.31 & 0.19\\
\hspace{1em}Tempo [Low] × Instrumentation [Group] × Participant country [Iran] × Music country [Iran] & 0.13 & 0.22 & 0.58 & 0.56\\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
Low & -1.58 & 0.19 & -1.94 & -1.21 & Low - High & -1.07 & 0.22 & -4.87 & \textbf{< 0.0001}\\
High & -0.50 & 0.17 & -0.83 & -0.18 &  &  &  &  & \\
\bottomrule
\end{tabular}
...
Tempo & EMM & $SE$ & $2.5\% CI$ & $97.5\% CI$ & Contrast & Difference & $SE$ & $z$ & $p$\\
\midrule
Low & -1.11 & 0.19 & -1.48 & -0.73 & Low - High & -0.81 & 0.21 & -3.77 & \textbf{< 0.001}\\
High & -0.30 & 0.18 & -0.65 & 0.06 &  &  &  &  & \\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
